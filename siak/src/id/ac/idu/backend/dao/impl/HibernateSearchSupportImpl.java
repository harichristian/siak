...
import id.ac.idu.backend.dao.HibernateSearchSupport;
...
public class HibernateSearchSupportImpl implements HibernateSearchSupport {
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.dao.impl.HibernateSearchSupport#count(java.lang.
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.dao.impl.HibernateSearchSupport#count(com.trg.search
      * .ISearch)
      */
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.dao.impl.HibernateSearchSupport#generateQL(java.
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.dao.impl.HibernateSearchSupport#generateRowCountQL
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.dao.impl.HibernateSearchSupport#getFilterFromExample
      * (java.lang.Object)
      */
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.dao.impl.HibernateSearchSupport#search(java.lang
      * .Class, com.trg.search.ISearch)
      */
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.dao.impl.HibernateSearchSupport#search(com.trg.search
      * .ISearch)
      */
    @SuppressWarnings("unchecked")
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.dao.impl.HibernateSearchSupport#searchAndCount(java
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.dao.impl.HibernateSearchSupport#searchAndCount(com
      * .trg.search.ISearch)
      */
    @SuppressWarnings("unchecked")
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.dao.impl.HibernateSearchSupport#searchUnique(java
      * .lang.Class, com.trg.search.ISearch)
      */
    @SuppressWarnings("unchecked")
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.dao.impl.HibernateSearchSupport#searchUnique(com
      * .trg.search.ISearch)
      */
