...
public class Mmhspascakhs implements java.io.Serializable {
    ...
    public Mmhspascakhs(int id, int mahasiswaId) {
        this.id = id;
        this.mahasiswaId = mahasiswaId;
    }

    public Mmhspascakhs(int id, Mpangkatgolongan mpangkatgolongan, int mahasiswaId, Mjabatan mjabatan
            , String cnip, String ckesatuan, Date dcreateddate, String ccreatedby, Date dupdateddate, String cupdatedby) {
        this.id = id;
