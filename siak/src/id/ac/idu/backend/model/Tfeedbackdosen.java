...
public class Tfeedbackdosen implements java.io.Serializable {
    ...
    /** default constructor */
    public Tfeedbackdosen() {
    }

	/** minimal constructor */
    public Tfeedbackdosen(int id, String cterm, Msekolah msekolah, Mprodi mprodi, String ckelompok, Mpegawai mpegawai, Mfeedback mfeedback, int nnopertanyaan) {
        this.id = id;
    ...
    /** full constructor */
    public Tfeedbackdosen(int id, String cterm, Msekolah msekolah, Mprodi mprodi, String ckelompok, Mpegawai mpegawai, Mfeedback mfeedback, int nnopertanyaan, String cjawaban, String ccreatedby, Date dcreateddate, String cupdateby, Date dupdateddate) {
        this.id = id;
        this.mfeedback = mfeedback;
        this.cterm = cterm;
        this.msekolah = msekolah;
