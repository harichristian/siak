...
public class Mstatusmhs implements java.io.Serializable {
    ...
    public Mstatusmhs(int id, String ckdstatmhs, String cnmstatmhs, String cketerangan, Date dcreateddate
            , String ccreatedby, Date dupdateddate, String cupdatedby, Set<Mmahasiswa> mmahasiswas) {
        this.id = id;
        this.ckdstatmhs = ckdstatmhs;
