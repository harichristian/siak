package id.ac.idu.backend.util.db.logging.service.impl;

import id.ac.idu.backend.model.HibernateEntityStatistics;
import id.ac.idu.backend.model.HibernateStatistics;
import id.ac.idu.backend.util.db.logging.service.LoggingService;
...
public class LoggingServiceImpl implements LoggingService {
    ...
    /*
      ...
      *
      * @see
      * id.ac.idu.backend.util.db.logging.service.LoggingService#saveStatistics
