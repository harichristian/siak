...
public class UpdateStatusMainCtrl extends GFCBaseCtrl implements Serializable {
    private static final long serialVersionUID = -8352659530536077973L;
    private static final Logger logger = Logger.getLogger(UpdateStatusMainCtrl.class);

    protected Window windowUpdateStatusMain;
    ...
    /* Page Controller */
    private UpdateStatusListCtrl listCtrl;
    private UpdateStatusDetailCtrl detailCtrl;
    ...
    public void onCreate$windowUpdateStatusMain(Event event) throws Exception {
        windowUpdateStatusMain.setContentStyle("padding:0px;");
        ...
        if (tabPanelList != null) {
            if(tabPanelList.getFirstChild() == null) ZksampleCommonUtils.createTabPanelContent(tabPanelList, this
                    , "ModuleMainController" , "/WEB-INF/pages/administrasi/updatestatus/pageList.zul");
        }
    }
    ...
    public void onSelect$tabList(Event event) throws IOException {
        ...
        if (tabPanelList != null) {
            if(tabPanelList.getFirstChild() == null)
                ZksampleCommonUtils.createTabPanelContent(tabPanelList, this , "ModuleMainController", "/WEB-INF/pages/administrasi/updatestatus/pageList.zul");
        }
    }
    ...
    public void onSelect$tabDetail(Event event) throws IOException {
        ...
        if (tabPanelDetail != null) {
            if(tabPanelDetail.getFirstChild() == null)
                ZksampleCommonUtils.createTabPanelContent(tabPanelDetail, this , "ModuleMainController", "/WEB-INF/pages/administrasi/updatestatus/pageDetail.zul");
        }
    }
    ...
    public void doResetToInitValues() {
        ...
        if (getOriginal() != null) {
            ...
            try {
                ...
                windowUpdateStatusMain.invalidate();
            } catch (final IllegalAccessException e) {
                throw new RuntimeException(e);
            } catch (final InstantiationException e) {
                throw new RuntimeException(e);
    ...
    public UpdateStatusListCtrl getListCtrl() {
        return listCtrl;
    }

    public void setListCtrl(UpdateStatusListCtrl listCtrl) {
        this.listCtrl = listCtrl;
    }

    public UpdateStatusDetailCtrl getDetailCtrl() {
        return detailCtrl;
    }

    public void setDetailCtrl(UpdateStatusDetailCtrl detailCtrl) {
