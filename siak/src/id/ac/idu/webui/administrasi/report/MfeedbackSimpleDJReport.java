 ...
 */
public class MfeedbackSimpleDJReport extends Window implements Serializable {
    ...
    public MfeedbackSimpleDJReport(Component parent) throws InterruptedException {
        super();
