 ...
 */
public class FeedbackWisudawanSimpleDJReport extends Window implements Serializable {
    ...
    private final String zksample2title = "Feedback Dosen Report";

    public FeedbackWisudawanSimpleDJReport(Component parent) throws InterruptedException {
        super();
    ...
    public void doPrint() throws JRException, ColumnBuilderException, ClassNotFoundException, IOException {
        ...
        drb.addColumn(nama, ConstantUtil.MAHASISWA_DOT_NAME, String.class.getName(), 20, columnStyleText, columnStyleTextBold);
        drb.addColumn(term, ConstantUtil.TERM, String.class.getName(), 50, columnStyleText, columnStyleTextBold);
        drb.addColumn(kelompok, ConstantUtil.KELOMPOK, String.class.getName(), 50, columnStyleText, columnStyleTextBold);
        drb.addColumn(prodi, ConstantUtil.PRODI_DOT_NAME, String.class.getName(), 50, columnStyleText, columnStyleTextBold);
        drb.addColumn(sekolah, ConstantUtil.SEKOLAH_DOT_NAME, String.class.getName(), 50, columnStyleText, columnStyleTextBold);

        // Sets the Report Columns, header, Title, Groups, Etc Formats
        // DynamicJasper documentation
        drb.setTitle(this.zksample2title);
        drb.setSubtitle("List of groups: " + ZksampleDateFormat.getDateTimeFormater().format(new Date()));
