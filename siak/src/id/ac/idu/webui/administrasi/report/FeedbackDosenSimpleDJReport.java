 ...
 */
public class FeedbackDosenSimpleDJReport extends Window implements Serializable {
    ...
    public FeedbackDosenSimpleDJReport(Component parent) throws InterruptedException {
        super();
