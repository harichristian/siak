 ...
 */
public class MpeminatanSimpleDJReport extends Window implements Serializable {
    ...
    public MpeminatanSimpleDJReport(Component parent) throws InterruptedException {
        super();
