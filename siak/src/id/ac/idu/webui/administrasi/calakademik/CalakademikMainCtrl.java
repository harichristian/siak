...
/**
 * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 * Main controller for the calakademik main module.<br>
 * <br>
 * zul-file: /WEB-INF/pages/administrasi/calakademik/calakademikMain.zul.<br>
 ...
 * <p/>
 * Managed tabs:<br>
 * - CalakademikListCtrl = Calakademik List / Filialen Liste<br>
 * - CalakademikDetailCtrl = Calakademik Details / Filiale-Details<br>
 */
public class CalakademikMainCtrl extends GFCBaseCtrl implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(CalakademikMainCtrl.class);
    ...
    */
    ...
    private CalakademikListCtrl calakademikListCtrl;
    private CalakademikDetailCtrl calakademikDetailCtrl;
    ...
    private CalakademikService calakademikService;
...
//                doCheckRights();
        ...
        if (tabPanelCalakademikList != null) {
            ZksampleCommonUtils.createTabPanelContent(tabPanelCalakademikList, this, "ModuleMainController", "/WEB-INF/pages/administrasi/calakademik/calakademikList.zul");
        }
    ...
    public void onSelect$tabCalakademikDetail(Event event) throws IOException {
        ...
        if (tabPanelCalakademikDetail.getFirstChild() != null) {
            ...
            getCalakademikDetailCtrl().setCalakademik(getSelectedCalakademik());
            getCalakademikDetailCtrl().getBinder().loadAll();
            return;
        }

        if (tabPanelCalakademikDetail != null) {
            ZksampleCommonUtils.createTabPanelContent(tabPanelCalakademikDetail, this, "ModuleMainController", "/WEB-INF/pages/administrasi/calakademik/calakademikDetail.zul");
        }
    }
    ...
    public void onCheck$checkbox_CalakademikList_ShowAll(Event event) {
        ...
        soCalakademik.addSort("cno", false);

        // Change the BindingListModel.
        if (getCalakademikListCtrl().getBinder() != null) {
            getCalakademikListCtrl().getPagedBindingListWrapper().setSearchObject(soCalakademik);
    ...
    public void onClick$button_CalakademikList_SearchNo(Event event) throws Exception {
        ...
        if (!txtb_Calakademik_No.getValue().isEmpty()) {
            ...
            // ++ create the searchObject and init sorting ++//
            HibernateSearchObject<Mcalakademik> soCalakademik = new HibernateSearchObject<Mcalakademik>(Mcalakademik.class, getCalakademikListCtrl().getCountRows());
            soCalakademik.addFilter(new Filter("cno", "%" + txtb_Calakademik_No.getValue() + "%", Filter.OP_ILIKE));
            soCalakademik.addSort("cno", false);
    ...
    private void doCancel(Event event) throws InterruptedException {
        ...
        if (getCalakademikDetailCtrl().getBinder() != null) {

            // refresh all dataBinder related controllers/components
            getCalakademikDetailCtrl().getBinder().loadAll();

            // set editable Mode
            getCalakademikDetailCtrl().doReadOnlyMode(true);
    ...
    private void doEdit(Event event) {
        ...
        getCalakademikDetailCtrl().doReadOnlyMode(false);
        // set focus
        getCalakademikDetailCtrl().txtb_filNr.focus();
    }
    ...
    private void doDelete(Event event) throws InterruptedException {
        ...
        if (anCalakademik != null) {
            ...
            if (MultiLineMessageBox.show(msg, title, Messagebox.YES | Messagebox.NO, Messagebox.QUESTION, true, new EventListener() {
                ...
                private void deleteBean() throws InterruptedException {
                     ...
                     */
                    if (getCalakademikDetailCtrl().getCalakademik().getId() <= 2) {
                        try {
                        ...
                        try {
                            getCalakademikService().delete(anCalakademik);
        ...
        // refresh the list
        getCalakademikListCtrl().doFillListbox();
    ...
    private void doSave(Event event) throws InterruptedException {
        ...
        getCalakademikDetailCtrl().getBinder().saveAll();
...
//                }
            ...
            // save it to database
            getCalakademikService().saveOrUpdate(getCalakademikDetailCtrl().getCalakademik());
            ...
            Events.postEvent("onSelect", getCalakademikListCtrl().getListBoxCalakademik(), getSelectedCalakademik());
    ...
    private void doNew(Event event) {
        ...
        final Mcalakademik anCalakademik = getCalakademikService().getNewCalakademik();

        // set the beans in the related databinded controllers
        getCalakademikDetailCtrl().setCalakademik(anCalakademik);
        getCalakademikDetailCtrl().setSelectedCalakademik(anCalakademik);

        // Refresh the binding mechanism
        getCalakademikDetailCtrl().setSelectedCalakademik(getSelectedCalakademik());
    ...
    private void doResizeSelectedTab(Event event) {
        ...
        if (tabbox_CalakademikMain.getSelectedTab() == tabCalakademikDetail) {
            getCalakademikDetailCtrl().doFitSize(event);
    ...
    public void setCalakademikListCtrl(CalakademikListCtrl calakademikListCtrl) {
        this.calakademikListCtrl = calakademikListCtrl;
    }

    public CalakademikListCtrl getCalakademikListCtrl() {
        return this.calakademikListCtrl;
    }

    public void setCalakademikDetailCtrl(CalakademikDetailCtrl calakademikDetailCtrl) {
        this.calakademikDetailCtrl = calakademikDetailCtrl;
    }

    public CalakademikDetailCtrl getCalakademikDetailCtrl() {
