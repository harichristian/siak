...
import id.ac.idu.webui.security.user.model.UserListModelItemRenderer;
import id.ac.idu.webui.security.user.report.UserSimpleDJReport;
...
public class UserListCtrl extends GFCBaseListCtrl<SecUser> implements Serializable {
     ...
     * see: id.ac.idu.webui.user.model.UserListModelItemRenderer.java <br>
     *
     * @param event
     * @throws Exception
     */
