 ...
 */
package id.ac.idu.webui.security.groupright;

import com.trg.search.Filter;
import id.ac.idu.backend.model.SecGroup;
import id.ac.idu.backend.model.SecGroupright;
import id.ac.idu.backend.model.SecRight;
import id.ac.idu.backend.service.SecurityService;
import id.ac.idu.backend.util.HibernateSearchObject;
import id.ac.idu.webui.security.groupright.model.SecGrouprightDialogGroupListModelItemRenderer;
import id.ac.idu.webui.security.groupright.model.SecGrouprightRightListModelItemRenderer;
