 ...
 */
package id.ac.idu.webui.security.role;

import com.trg.search.Filter;
import id.ac.idu.backend.model.SecRole;
import id.ac.idu.backend.service.SecurityService;
import id.ac.idu.backend.util.HibernateSearchObject;
import id.ac.idu.webui.security.role.model.SecRoleListModelItemRenderer;
import id.ac.idu.webui.security.role.report.SecRoleSimpleDJReport;
...
public class SecRoleListCtrl extends GFCBaseListCtrl<SecRole> implements Serializable {
     ...
     * see: id.ac.idu.webui.security.role.model.SecRoleListModelItemRenderer.
     * java <br>
     *
     * @param event
     * @throws Exception
