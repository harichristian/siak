 ...
 */
package id.ac.idu.webui.security.group;

import com.trg.search.Filter;
import id.ac.idu.backend.model.SecGroup;
import id.ac.idu.backend.service.SecurityService;
import id.ac.idu.backend.util.HibernateSearchObject;
import id.ac.idu.webui.security.group.model.SecGroupListModelItemRenderer;
import id.ac.idu.webui.security.group.report.SecGroupSimpleDJReport;
...
public class SecGroupListCtrl extends GFCBaseListCtrl<SecGroup> implements Serializable {
     ...
     * see:
     * id.ac.idu.webui.security.group.model.SecGroupListModelItemRenderer
     * .java <br>
     *
     * @param event
     * @throws Exception
