 ...
 */
public class MkelExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(MkelExtendedSearchListBox.class);
    ...
    private Mkel obj = null;

    // The service from which we get the data
    private MkelService objService;
     ...
     */
    public static Mkel show(Component parent) {
        return new MkelExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private MkelExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
        ...
        List<Mkel> resultList = (List<Mkel>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Listcell lc = new Listcell(mkel.getCnamaKel());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mkel mkel= (Mkel) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = MkelExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (MkelExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = MkelExtendedSearchListBox.this.listbox.getSelectedItem();
                Mkel mkel = (Mkel) li.getAttribute("data");
    ...
    public void setObj(Mkel obj) {
        this.obj = obj;
    }

    public MkelService getObjService() {
        if (this.objService == null) {
            this.objService = (MkelService) SpringUtil.getBean("mkelService");
        }
        return objService;
    }

    public void setObjService(MkelService objService) {
