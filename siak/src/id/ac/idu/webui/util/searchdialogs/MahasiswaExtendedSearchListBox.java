 ...
 */
public class MahasiswaExtendedSearchListBox extends Window implements Serializable {
    ...
    private Mmahasiswa obj = null;

    // The service from which we get the data
    private MahasiswaService objService;
     ...
     */
    public static Mmahasiswa show(Component parent) {
        return new MahasiswaExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private MahasiswaExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllMmahasiswaLikeText("", 0, getPageSize());
        List<Mmahasiswa> resultList = (List<Mmahasiswa>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mmahasiswa mmahasiswa = (Mmahasiswa) data;

            Listcell lc = new Listcell(mmahasiswa.getCnama());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mmahasiswa mmahasiswa = (Mmahasiswa) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = MahasiswaExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllMmahasiswaLikeText(searchText, start, getPageSize());
        List<Mmahasiswa> resultList = (List<Mmahasiswa>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (MahasiswaExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = MahasiswaExtendedSearchListBox.this.listbox.getSelectedItem();
                Mmahasiswa mmahasiswa = (Mmahasiswa) li.getAttribute("data");
    ...
    public Mmahasiswa getObj() {
        return obj;
    }

    public void setObj(Mmahasiswa obj) {
        this.obj = obj;
    }

    public MahasiswaService getObjService() {
        if (this.objService == null) {
            this.objService = (MahasiswaService) SpringUtil.getBean("mahasiswaService");
        }
        return objService;
    }

    public void setObjService(MahasiswaService objService) {
