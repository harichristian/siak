 ...
 */
public class MprovExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(MprovExtendedSearchListBox.class);
    ...
    private Mprov obj = null;

    // The service from which we get the data
    private MprovService objService;
     ...
     */
    public static Mprov show(Component parent) {
        return new MprovExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private MprovExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
        ...
        List<Mprov> resultList = (List<Mprov>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mprov mprov = (Mprov) data;

            Listcell lc = new Listcell(mprov.getCnamaProv());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mprov mprov= (Mprov) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = MprovExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (MprovExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = MprovExtendedSearchListBox.this.listbox.getSelectedItem();
                Mprov mprov = (Mprov) li.getAttribute("data");
    ...
    public void setObj(Mprov obj) {
        this.obj = obj;
    }

    public MprovService getObjService() {
        if (this.objService == null) {
            this.objService = (MprovService) SpringUtil.getBean("mprovService");
        }
        return objService;
    }

    public void setObjService(MprovService objService) {
