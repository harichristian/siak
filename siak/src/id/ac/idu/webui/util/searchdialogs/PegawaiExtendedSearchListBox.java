 ...
 */
public class PegawaiExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(PegawaiExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Pegawai";
    ...
    private Mpegawai obj = null;

    // The service from which we get the data
    private PegawaiService objService;
     ...
     */
    public static Mpegawai show(Component parent) {
        return new PegawaiExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private PegawaiExtendedSearchListBox(Component parent) {
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllPegawaiLikeText("", 0, getPageSize());
        List<Mpegawai> resultList = (List<Mpegawai>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mpegawai pegawai = (Mpegawai) data;

            Listcell lc = new Listcell(pegawai.getCnama());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mpegawai pegawai = (Mpegawai) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = PegawaiExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllPegawaiLikeText(searchText, start, getPageSize());
        List<Mpegawai> resultList = (List<Mpegawai>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (PegawaiExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = PegawaiExtendedSearchListBox.this.listbox.getSelectedItem();
                Mpegawai pegawai = (Mpegawai) li.getAttribute("data");
    ...
    public Mpegawai getObj() {
        return obj;
    }

    public void setObj(Mpegawai obj) {
        this.obj = obj;
    }

    public PegawaiService getObjService() {
        if (this.objService == null) {
            this.objService = (PegawaiService) SpringUtil.getBean("pegawaiService");
        }
        return objService;
    }

    public void setObjService(PegawaiService objService) {
