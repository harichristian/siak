 ...
 */
public class SekolahExtendedSearchListBox  extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(SekolahExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Sekolah";
    ...
    private Msekolah obj = null;

    // The service from which we get the data
    private SekolahService objService;
     ...
     */
    public static Msekolah show(Component parent) {
        return new SekolahExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private SekolahExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllSekolahLikeText("", 0, getPageSize());
        List<Msekolah> resultList = (List<Msekolah>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Msekolah sekolah = (Msekolah) data;

            Listcell lc = new Listcell(sekolah.getCnamaSekolah());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Msekolah sekolah = (Msekolah) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = SekolahExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllSekolahLikeText(searchText, start, getPageSize());
        List<Msekolah> resultList = (List<Msekolah>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (SekolahExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = SekolahExtendedSearchListBox.this.listbox.getSelectedItem();
                Msekolah sekolah = (Msekolah) li.getAttribute("data");
    ...
    public Msekolah getObj() {
        return obj;
    }

    public void setObj(Msekolah obj) {
        this.obj = obj;
    }

    public SekolahService getObjService() {
        if (this.objService == null) {
            this.objService = (SekolahService) SpringUtil.getBean("sekolahService");
        }
        return objService;
    }

    public void setObjService(SekolahService objService) {
