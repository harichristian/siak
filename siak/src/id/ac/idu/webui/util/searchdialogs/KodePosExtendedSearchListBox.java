 ...
 */
public class KodePosExtendedSearchListBox extends Window implements Serializable {
    ...
    private MkodePos obj = null;

    // The service from which we get the data
    private KodePosService objService;
     ...
     */
    public static MkodePos show(Component parent) {
        return new KodePosExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private KodePosExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllMkodePosLikeText("", 0, getPageSize());
        List<MkodePos> resultList = (List<MkodePos>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            MkodePos mkodePos = (MkodePos) data;

            Listcell lc = new Listcell(mkodePos.getKodepos());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            MkodePos mkodePos = (MkodePos) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = KodePosExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllMkodePosLikeText(searchText, start, getPageSize());
        List<MkodePos> resultList = (List<MkodePos>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (KodePosExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = KodePosExtendedSearchListBox.this.listbox.getSelectedItem();
                MkodePos mkodePos = (MkodePos) li.getAttribute("data");
    ...
    public MkodePos getObj() {
        return obj;
    }

    public void setObj(MkodePos obj) {
        this.obj = obj;
    }

    public KodePosService getObjService() {
        if (this.objService == null) {
            this.objService = (KodePosService) SpringUtil.getBean("kodePosService");
        }
        return objService;
    }

    public void setObjService(KodePosService objService) {
