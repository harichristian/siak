 ...
 */
public class MruangExtendedSearchListBox extends Window implements Serializable {
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Ruang";
    ...
    private Mruang obj = null;

    // The service from which we get the data
    private MruangService objService;
     ...
     */
    public static Mruang show(Component parent) {
        return new MruangExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private MruangExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllMruangLikeText("", 0, getPageSize());
        List<Mruang> resultList = (List<Mruang>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mruang mruang = (Mruang) data;

            Listcell lc = new Listcell(mruang.getCnmRuang());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mruang mruang = (Mruang) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = MruangExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllMruangLikeText(searchText, start, getPageSize());
        List<Mruang> resultList = (List<Mruang>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (MruangExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = MruangExtendedSearchListBox.this.listbox.getSelectedItem();
                Mruang mruang = (Mruang) li.getAttribute("data");
    ...
    public Mruang getObj() {
        return obj;
    }

    public void setObj(Mruang obj) {
        this.obj = obj;
    }

    public MruangService getObjService() {
        if (this.objService == null) {
            this.objService = (MruangService) SpringUtil.getBean("mruangService");
        }
        return objService;
    }

    public void setObjService(MruangService objService) {
