 ...
 */
public class MatakuliahExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(MatakuliahExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Matakuliah";
    ...
    private Mtbmtkl obj = null;

    // The service from which we get the data
    private MatakuliahService objService;
     ...
     */
    public static Mtbmtkl show(Component parent) {
        return new MatakuliahExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private MatakuliahExtendedSearchListBox(Component parent) {
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllMatakuliahLikeText("", 0, getPageSize());
        List<Mtbmtkl> resultList = (List<Mtbmtkl>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mtbmtkl matakuliah = (Mtbmtkl) data;

            Listcell lc = new Listcell(matakuliah.getCnamamk());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mtbmtkl matakuliah = (Mtbmtkl) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = MatakuliahExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllMatakuliahLikeText(searchText, start, getPageSize());
        List<Mtbmtkl> resultList = (List<Mtbmtkl>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (MatakuliahExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = MatakuliahExtendedSearchListBox.this.listbox.getSelectedItem();
                Mtbmtkl matakuliah = (Mtbmtkl) li.getAttribute("data");
    ...
    public Mtbmtkl getObj() {
        return obj;
    }

    public void setObj(Mtbmtkl obj) {
        this.obj = obj;
    }

    public MatakuliahService getObjService() {
        if (this.objService == null) {
            this.objService = (MatakuliahService) SpringUtil.getBean("matakuliahService");
        }
        return objService;
    }

    public void setObjService(MatakuliahService objService) {
