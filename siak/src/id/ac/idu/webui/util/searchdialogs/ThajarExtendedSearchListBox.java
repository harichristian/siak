 ...
 */
public class ThajarExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(ThajarExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Thajar";
    ...
    private Mthajar obj = null;

    // The service from which we get the data
    private ThajarService objService;
     ...
     */
    public static Mthajar show(Component parent) {
        return new ThajarExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private ThajarExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllThajarLikeText("", 0, getPageSize());
        List<Mthajar> resultList = (List<Mthajar>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mthajar thajar = (Mthajar) data;

            Listcell lc = new Listcell(thajar.getCthajar());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mthajar thajar = (Mthajar) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = ThajarExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllThajarLikeText(searchText, start, getPageSize());
        List<Mthajar> resultList = (List<Mthajar>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (ThajarExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = ThajarExtendedSearchListBox.this.listbox.getSelectedItem();
                Mthajar thajar = (Mthajar) li.getAttribute("data");
    ...
    public Mthajar getObj() {
        return obj;
    }

    public void setObj(Mthajar obj) {
        this.obj = obj;
    }

    public ThajarService getObjService() {
        if (this.objService == null) {
            this.objService = (ThajarService) SpringUtil.getBean("thajarService");
        }
        return objService;
    }

    public void setObjService(ThajarService objService) {
