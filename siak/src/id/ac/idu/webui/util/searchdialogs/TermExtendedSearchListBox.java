 ...
 */
public class TermExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(TermExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Term";
    ...
    private Mterm obj = null;

    // The service from which we get the data
    private TermService objService;
     ...
     */
    public static Mterm show(Component parent) {
        return new TermExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private TermExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllTermLikeText("", 0, getPageSize());
        List<Mterm> resultList = (List<Mterm>) ro.getList();
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mterm term = (Mterm) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = TermExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllTermLikeText(searchText, start, getPageSize());
        List<Mterm> resultList = (List<Mterm>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (TermExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = TermExtendedSearchListBox.this.listbox.getSelectedItem();
                Mterm term = (Mterm) li.getAttribute("data");
    ...
    public void setObj(Mterm obj) {
        this.obj = obj;
    }

    public TermService getObjService() {
        if (this.objService == null) {
            this.objService = (TermService) SpringUtil.getBean("termService");
        }
        return objService;
    }

    public void setObjService(TermService objService) {
