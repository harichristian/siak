 ...
 */
public class JenjangExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(JenjangExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Jenjang";
    ...
    private Mjenjang obj = null;

    // The service from which we get the data
    private JenjangService objService;
     ...
     */
    public static Mjenjang show(Component parent) {
        return new JenjangExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private JenjangExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllJenjangLikeText("", 0, getPageSize());
        List<Mjenjang> resultList = (List<Mjenjang>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mjenjang jenjang = (Mjenjang) data;

            Listcell lc = new Listcell(jenjang.getCnmjen());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mjenjang jenjang = (Mjenjang) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = JenjangExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllJenjangLikeText(searchText, start, getPageSize());
        List<Mjenjang> resultList = (List<Mjenjang>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (JenjangExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = JenjangExtendedSearchListBox.this.listbox.getSelectedItem();
                Mjenjang jenjang = (Mjenjang) li.getAttribute("data");
    ...
    public Mjenjang getObj() {
        return obj;
    }

    public void setObj(Mjenjang obj) {
        this.obj = obj;
    }

    public JenjangService getObjService() {
        if (this.objService == null) {
            this.objService = (JenjangService) SpringUtil.getBean("jenjangService");
        }
        return objService;
    }

    public void setObjService(JenjangService objService) {
