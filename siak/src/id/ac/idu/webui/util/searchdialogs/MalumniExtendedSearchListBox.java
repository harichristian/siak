 ...
 */
public class MalumniExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(MalumniExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Alumni";
    ...
    private Malumni obj = null;

    // The service from which we get the data
    private MalumniService objService;
     ...
     */
    public static Malumni show(Component parent) {
        return new MalumniExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private MalumniExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
        ...
        List<Malumni> resultList = (List<Malumni>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Malumni malumni = (Malumni) data;

            Listcell lc = new Listcell(malumni.getMmahasiswa().getCnama());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Malumni malumni= (Malumni) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = MalumniExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (MalumniExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = MalumniExtendedSearchListBox.this.listbox.getSelectedItem();
                Malumni malumni = (Malumni) li.getAttribute("data");
    ...
    public Malumni getObj() {
        return obj;
    }

    public void setObj(Malumni obj) {
        this.obj = obj;
    }

    public MalumniService getObjService() {
        if (this.objService == null) {
            this.objService = (MalumniService) SpringUtil.getBean("malumniService");
        }
        return objService;
    }

    public void setObjService(MalumniService objService) {
