 ...
 */
public class KartustudiSimpleDJReport extends Window implements Serializable {
    ...
    private final String zksample2title = "Laporan Kartu Studi Mahasiswa";

    private Tjadkulmaster param;

    public KartustudiSimpleDJReport(Component parent, Tjadkulmaster obj) throws InterruptedException {
        super();
    ...
    private void callReportWindow(AMedia aMedia, String format) {
        ...
        setTitle("Laporan Kartu Studi Mahasiswa");
        setId("ReportWindow");
        setVisible(true);
        setMaximizable(true);
        setMinimizable(true);
