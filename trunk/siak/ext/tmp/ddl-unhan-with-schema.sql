...
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.INDEX_APP_NEWS_ID ON APP_NEWS (
ANW_ID
);
...
/* INDEX: IDX_BRA_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_BRA_ID ON BRANCHE (
BRA_ID
);
...
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_BRA_BEZEICHNUNG ON BRANCHE (
BRA_BEZEICHNUNG
);
...
/* INDEX: IDX_ART_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_ART_ID ON ARTIKEL (
ART_ID
);
...
/* INDEX: IDX_ART_NR */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_ART_NR ON ARTIKEL (
ART_NR
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IDX_ART_BEZEICHNUNG ON ARTIKEL (
ART_KURZBEZEICHNUNG
);
...
/* INDEX: IX_AUF_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IX_AUF_ID ON AUFTRAG (
AUF_ID
);
...
/* INDEX: IX_AUF_KUN_ID */
/*==============================================================*/
CREATE INDEX  SIAK.IX_AUF_KUN_ID ON AUFTRAG (
AUF_KUN_ID
);
...
/* INDEX: IX_AUF_NR */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IX_AUF_NR ON AUFTRAG (
AUF_NR
);
...
/* INDEX: IX_AUP_AUF_ID */
/*==============================================================*/
CREATE INDEX  SIAK.IX_AUP_AUF_ID ON AUFTRAGPOSITION (
AUP_AUF_ID
);
...
/* INDEX: IX_AUP_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IX_AUP_ID ON AUFTRAGPOSITION (
AUP_ID
);
...
/* INDEX: IDX_CLE_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_CLE_ID ON CALENDAR_EVENT (
CLE_ID
);
...
/* INDEX: IX_FIL_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IX_FIL_ID ON FILIALE (
FIL_ID
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IX_FIL_BEZEICHNUNG ON FILIALE (
FIL_BEZEICHNUNG
);
...
/* INDEX: IX_FIL_NR */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IX_FIL_NR ON FILIALE (
FIL_NR
);
...
/* INDEX: IDX_GUB_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_GUB_ID ON GUESTBOOK (
GUB_ID
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IDX_GUB_SUBJECT ON GUESTBOOK (
GUB_SUBJECT
);
...
/* INDEX: IDX_GUB_DATE */
/*==============================================================*/
CREATE INDEX  SIAK.IDX_GUB_DATE ON GUESTBOOK (
GUB_DATE
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IDX_GUB_USR_NAME ON GUESTBOOK (
GUB_USR_NAME
);
...
/* INDEX: IDX_IPC_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_IPC_ID ON IPC_IP2COUNTRY (
IPC_ID
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IDX_IPC_IP_FROM ON IPC_IP2COUNTRY (
IPC_IP_FROM
);
...
/* INDEX: IDX_IPC_IP_TO */
/*==============================================================*/
CREATE INDEX  SIAK.IDX_IPC_IP_TO ON IPC_IP2COUNTRY (
IPC_IP_TO
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IDX_IPC_COUNTRY_CODE2 ON IPC_IP2COUNTRY (
IPC_COUNTRY_CODE2
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IDX_IPC_COUNTRY_CODE3 ON IPC_IP2COUNTRY (
IPC_COUNTRY_CODE3
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IDX_IPC_COUNTRY_NAME ON IPC_IP2COUNTRY (
IPC_COUNTRY_NAME
);
...
/* INDEX: IX_KUN_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IX_KUN_ID ON KUNDE (
KUN_ID
);
...
/* INDEX: IX_KUN_FIL_ID */
/*==============================================================*/
CREATE INDEX  SIAK.IX_KUN_FIL_ID ON KUNDE (
KUN_FIL_ID
);
...
/* INDEX: IX_KUN_NR */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IX_KUN_NR ON KUNDE (
KUN_NR
);
...
/* INDEX: IDX_I2C_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_I2C_ID ON LOG_IP2COUNTRY (
I2C_ID
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IDX_I2C_CCD_ID ON LOG_IP2COUNTRY (
CCD_ID
);
...
/* INDEX: IDX_GRP_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_GRP_ID ON SEC_GROUP (
GRP_ID
);
...
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_GRP_SHORTDESCRIPTION ON SEC_GROUP (
...
/* INDEX: IDX_GRI_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_GRI_ID ON SEC_GROUPRIGHT (
GRI_ID
);
...
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_GRI_GRPRIG ON SEC_GROUPRIGHT (
GRP_ID,
RIG_ID
);
...
/* INDEX: IDX_LGL_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_LGL_ID ON SEC_LOGINLOG (
LGL_ID
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IDX_LGL_LOGTIME ON SEC_LOGINLOG (
LGL_LOGTIME
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IDX_LGL_I2C_ID ON SEC_LOGINLOG (
I2C_ID
);
...
/* INDEX: IDX_RIG_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_RIG_ID ON SEC_RIGHT (
RIG_ID
);
...
/* INDEX: IDX_RIG_TYPE */
/*==============================================================*/
CREATE INDEX  SIAK.IDX_RIG_TYPE ON SEC_RIGHT (
RIG_TYPE
);
...
/* INDEX: IDX_RIG_NAME */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_RIG_NAME ON SEC_RIGHT (
RIG_NAME
);
...
/* INDEX: IDX_ROLE_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_ROLE_ID ON SEC_ROLE (
ROL_ID
);
...
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_ROLE_SHORTDESCRIPTION ON SEC_ROLE (
...
/* INDEX: IDX_RLG_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_RLG_ID ON SEC_ROLEGROUP (
RLG_ID
);
...
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_RLG_GRPROL ON SEC_ROLEGROUP (
GRP_ID,
ROL_ID
);
...
/* INDEX: IDX_USR_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_USR_ID ON SEC_USER (
USR_ID
);
...
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_USR_LOGINNAME ON SEC_USER (
USR_LOGINNAME
);
...
/* INDEX: IDX_URR_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_URR_ID ON SEC_USERROLE (
URR_ID
);
...
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_URR_USRROL ON SEC_USERROLE (
USR_ID,
ROL_ID
);
...
/* INDEX: IDX_CCD_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_CCD_ID ON SYS_COUNTRYCODE (
CCD_ID
);
...
/* INDEX: IDX_CCD_CODE2 */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_CCD_CODE2 ON SYS_COUNTRYCODE (
CCD_CODE2
);
...
/* INDEX: IDX_I4CO_ID */
/*==============================================================*/
CREATE UNIQUE INDEX SIAK.IDX_I4CO_ID ON SYS_IP4COUNTRY (
I4CO_ID
);
...
/* INDEX: IDX_I4CO_IP */
/*==============================================================*/
CREATE INDEX  SIAK.IDX_I4CO_IP ON SYS_IP4COUNTRY (
I4CO_IP
);
...
/*==============================================================*/
CREATE INDEX  SIAK.IDX_I4CO_CCD_ID ON SYS_IP4COUNTRY (
I4CO_CCD_ID
);
...
CREATE UNIQUE INDEX SIAK.PK_MKARYAMHS ON MKARYAMHS (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MJENJANG ON MJENJANG (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_AUFTRAG ON AUFTRAG (AUF_ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MHARI ON MHARI (ID ASC);

CREATE UNIQUE INDEX SIAK.UN_KAB ON MKAB (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MPRODI ON MPRODI (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MKGTMHS ON MKGTMHS (ID ASC);

CREATE UNIQUE INDEX SIAK.UN_PROV ON MPROV (ID ASC);

CREATE UNIQUE INDEX SIAK.UN_SEKOLAH ON MSEKOLAH (ID ASC);

CREATE UNIQUE INDEX SIAK.UN_BIDUSAHA ON MBIDANGUSAHA (CBIDUSHINS ASC);

CREATE UNIQUE INDEX SIAK.PK_SEC_ROLEGROUP ON SEC_ROLEGROUP (RLG_ID ASC);

CREATE UNIQUE INDEX SIAK.PK_CALENDAR_EVENT ON CALENDAR_EVENT (CLE_ID ASC);

CREATE UNIQUE INDEX SIAK.TDAFTARTUGASMENULIS_PK ON TDAFTARTUGASMENULIS (NRECID ASC);

CREATE UNIQUE INDEX SIAK.TCUTIMHS_PK ON TCUTIMHS (CNOSURAT ASC);

CREATE UNIQUE INDEX SIAK.PK_MSESIKULIAH ON MSESIKULIAH (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MKURMHS ON MKURMHS (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MJABATAN ON MJABATAN (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MMHSPASCAKHS ON MMHSPASCAKHS (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_TABSENDOSEN ON TABSENDOSEN (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MPEMINATAN ON MPEMINATAN (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MALUMNI ON MALUMNI (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_TPAKETKULIAH ON TPAKETKULIAH (ID ASC);

CREATE UNIQUE INDEX SIAK.TJADUJIAN_PK ON TJADUJIAN (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_FEDD ON TFEEDBACKINSTANSI (ID ASC);

CREATE UNIQUE INDEX SIAK.TDAFTARWISUDA_UK ON TDAFTARWISUDA (CKDSEKOLAH ASC, CKDPROGST ASC, CTERM ASC, CNIM ASC);

CREATE UNIQUE INDEX SIAK.PK_MCALAKADEMIK ON MCALAKADEMIK (ID ASC);

CREATE UNIQUE INDEX SIAK.UN_KDPOS ON MKODE_POS (ID ASC);

CREATE UNIQUE INDEX SIAK.TLOGNILAI_PK ON TLOGNILAI (ID ASC);

CREATE UNIQUE INDEX SIAK.TFEEDBACKKULIAH_UK ON TFEEDBACKKULIAH (CTERM ASC, SEKOLAH_ID ASC, PRODI_ID ASC, CKELOMPOK ASC, MATAKULIAH_ID ASC, MAHASISWA_ID ASC, CKDFEEDBACK ASC, NNOPERTANYAAN ASC);

CREATE UNIQUE INDEX SIAK.UN_RUANG ON MRUANG (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_BIDUSAHA ON MBIDANGUSAHA (ID ASC);

CREATE UNIQUE INDEX SIAK.TJADSIDANGTUGASMENULIS_CKDSEKOLAH_UN ON TJADSIDANGTUGASMENULIS (CKDSEKOLAH ASC, CKDPROGST ASC, CTERM ASC, CNIM ASC, CNIP ASC);

CREATE UNIQUE INDEX SIAK.UN_FASILITAS ON MFASILITAS (ID ASC);

CREATE UNIQUE INDEX SIAK.TJADKULMASTER_PK ON TJADKULMASTER (ID ASC);

CREATE UNIQUE INDEX SIAK.TIRSPASCA_UK ON TIRSPASCA (CTERM ASC, SEKOLAH_ID ASC, PRODI_ID ASC, MATAKULIAH_ID ASC, CKELOMPOK ASC, MAHASISWA_ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MDETILKURIKULUM ON MDETILKURIKULUM (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MHISTPNDDKMHS ON MHISTPNDDKMHS (ID ASC);

CREATE UNIQUE INDEX SIAK.TDAFTARWISUDA_PK ON TDAFTARWISUDA (NRECID ASC);

CREATE UNIQUE INDEX SIAK.TIRSPASCA_PK ON TIRSPASCA (ID ASC);

CREATE UNIQUE INDEX SIAK.IDX_ART_NR ON ARTIKEL (ART_NR ASC);

CREATE UNIQUE INDEX SIAK.UN_FASILITASRUANG ON MFASILITASRUANG (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MHISTKURSUSMHS ON MHISTKURSUSMHS (ID ASC);

CREATE INDEX  SIAK.IDX_IPC_COUNTRY_CODE2 ON IPC_IP2COUNTRY (IPC_COUNTRY_CODE2 ASC);

CREATE UNIQUE INDEX SIAK.PK_MSTATUSMHS ON MSTATUSMHS (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_TABSENMHS ON TABSENMHS (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MPRESTASIMHS ON MPRESTASIMHS (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_HISTORY ON THISTKERJA (ID ASC);

CREATE UNIQUE INDEX SIAK.TJADKULMASTER_UK ON TJADKULMASTER (CTERM ASC, SEKOLAH_ID ASC, PRODI_ID ASC, MATAKULIAH_ID ASC, CKELOMPOK ASC);

CREATE UNIQUE INDEX SIAK.TDAFTARTUGASMENULIS_UK ON TDAFTARTUGASMENULIS (CKDSEKOLAH ASC, CKDPROGST ASC, CTERM ASC, CNIM ASC, CJENISMENULIS ASC);

CREATE UNIQUE INDEX SIAK.PK_TERM ON MTERM (ID ASC);

CREATE UNIQUE INDEX SIAK.TJADKULDETIL_PK ON TJADKULDETIL (ID ASC);

CREATE UNIQUE INDEX SIAK.UN_KDTERM ON MTERM (KD_TERM ASC);

CREATE UNIQUE INDEX SIAK.PK_MPPUMHSKHUSUS ON MPPUMHSKHUSUS (ID ASC);

CREATE UNIQUE INDEX SIAK.IDX_RLG_GRPROL ON SEC_ROLEGROUP (GRP_ID ASC, ROL_ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MHISTPANGKATMHS ON MHISTPANGKATMHS (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MMAHASISWA ON MMAHASISWA (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_APP_NEWS ON APP_NEWS (ANW_ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MPEGAWAI ON MPEGAWAI (ID ASC);

CREATE UNIQUE INDEX SIAK.TFEEDBACKKULIAH_PK ON TFEEDBACKKULIAH (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MKURIKULUM ON MKURIKULUM (ID ASC);

CREATE UNIQUE INDEX SIAK.IX_AUF_NR ON AUFTRAG (AUF_NR ASC);

CREATE UNIQUE INDEX SIAK.UN_HISKERJA ON THISTKERJA (CTERM ASC, SEKOLAH_ID ASC, PRODI_ID ASC, CNIM ASC, NNOURUT ASC);

CREATE INDEX  SIAK.IDX_IPC_COUNTRY_CODE3 ON IPC_IP2COUNTRY (IPC_COUNTRY_CODE3 ASC);

CREATE UNIQUE INDEX SIAK.UN_KEL ON MKEL (ID ASC);

CREATE UNIQUE INDEX SIAK.TJADKULDETIL_UK ON TJADKULDETIL (CTERM ASC, SEKOLAH_ID ASC, PRODI_ID ASC, MATAKULIAH_ID ASC, CKELOMPOK ASC, HARI_ID ASC, SESI_ID ASC, RUANG_ID ASC);

CREATE UNIQUE INDEX SIAK.UN_KEC ON MKEC (ID ASC);

CREATE UNIQUE INDEX SIAK.TJADSIDANGTUGASMENULIS_PK ON TJADSIDANGTUGASMENULIS (NRECID ASC);

CREATE UNIQUE INDEX SIAK.PK_MTBMTKL ON MTBMTKL (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MPBAHASAMHS ON MPBAHASAMHS (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MKEGIATAN ON MKEGIATAN (ID ASC);

CREATE UNIQUE INDEX SIAK.TJADUJIAN_UK ON TJADUJIAN (CTERM ASC, SEKOLAH_ID ASC, PRODI_ID ASC, MATAKULIAH_ID ASC, CKELOMPOK ASC, HARI_ID ASC, SESI_ID ASC, RUANG_ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MPANGKATGOLONGAN ON MPANGKATGOLONGAN (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_UNIV ON MUNIV (ID ASC);

CREATE UNIQUE INDEX SIAK.PK_MGRADE ON MGRADE (ID ASC);

ALTER TABLE  SIAK.TABSENMHS ADD CONSTRAINT PK_TABSENMHS PRIMARY KEY (ID);

ALTER TABLE  SIAK.MKEC ADD CONSTRAINT PK_KEC PRIMARY KEY (ID);
...
ALTER TABLE  SIAK.MPROV ADD CONSTRAINT PK_PROV PRIMARY KEY (ID);
...
ALTER TABLE  SIAK.MSEKOLAH ADD CONSTRAINT PK_SEKOLAH PRIMARY KEY (ID);
...
ALTER TABLE  SIAK.MKEL ADD CONSTRAINT PK_KEL PRIMARY KEY (ID);
...
ALTER TABLE  SIAK.MFASILITASRUANG ADD CONSTRAINT PK_FASRUANG PRIMARY KEY (ID);
...
ALTER TABLE  SIAK.MFASILITASRUANG ADD CONSTRAINT FK_FAS_FASRUANG FOREIGN KEY (FASILITAS_ID) REFERENCES MFASILITAS (ID)  ON DELETE NO ACTION ON UPDATE NO ACTION ENFORCED  ENABLE QUERY OPTIMIZATION ;
 
ALTER TABLE  SIAK.MFASILITASRUANG ADD CONSTRAINT FK_RUANGFAS FOREIGN KEY (RUANG_ID) REFERENCES MRUANG (ID)  ON DELETE NO ACTION ON UPDATE NO ACTION ENFORCED  ENABLE QUERY OPTIMIZATION ;


/* drop the sequences */
DROP SEQUENCE SIAK.MDETILKURIKULUM_SEQ;
DROP SEQUENCE SIAK.MCALAKADEMIK_SEQ;
DROP SEQUENCE SIAK.MFASILITAS_SEQ;
DROP SEQUENCE SIAK.MFASILITASRUANG_SEQ;
DROP SEQUENCE SIAK.MGRADE_SEQ;
DROP SEQUENCE SIAK.MHARI_SEQ;
DROP SEQUENCE SIAK.MHISTPNDDKMHS_SEQ;
DROP SEQUENCE SIAK.MHISTKURSUSMHS_SEQ;
DROP SEQUENCE SIAK.MHISTPANGKATMHS_SEQ;
DROP SEQUENCE SIAK.MJABATAN_SEQ;
DROP SEQUENCE SIAK.MJENJANG_SEQ;
DROP SEQUENCE SIAK.MKARYAMHS_SEQ;
DROP SEQUENCE SIAK.MKAB_SEQ;
DROP SEQUENCE SIAK.MKEC_SEQ;
DROP SEQUENCE SIAK.MKEL_SEQ;
DROP SEQUENCE SIAK.MKEGIATAN_SEQ;
DROP SEQUENCE SIAK.MKGTMHS_SEQ;
DROP SEQUENCE SIAK.MKODE_POS_SEQ;
DROP SEQUENCE SIAK.MKURIKULUM_SEQ;
DROP SEQUENCE SIAK.MKURMHS_SEQ;
DROP SEQUENCE SIAK.MMAHASISWA_SEQ;
DROP SEQUENCE SIAK.MMHSPASCAKHS_SEQ;
DROP SEQUENCE SIAK.MPANGKATGOLONGAN_SEQ;
DROP SEQUENCE SIAK.MPBAHASAMHS_SEQ;
DROP SEQUENCE SIAK.MPEGAWAI_SEQ;
DROP SEQUENCE SIAK.MPEMINATAN_SEQ;
DROP SEQUENCE SIAK.MPPUMHSKHUSUS_SEQ;
DROP SEQUENCE SIAK.MPRESTASIMHS_SEQ;
DROP SEQUENCE SIAK.MPRODI_SEQ;
DROP SEQUENCE SIAK.MPROV_SEQ;
DROP SEQUENCE SIAK.MRUANG_SEQ;
DROP SEQUENCE SIAK.MSEKOLAH_SEQ;
DROP SEQUENCE SIAK.MSESIKULIAH_SEQ;
DROP SEQUENCE SIAK.MSTATUSMHS_SEQ;
DROP SEQUENCE SIAK.MTBMTKL_SEQ;
DROP SEQUENCE SIAK.MUNIV_SEQ;
