...
CREATE TABLE MFASILITAS (
		...
		CNAMA_FASILITAS VARCHAR(50) NOT NULL,
		DCREATEDDATE DATE,
		CCREATEDBY VARCHAR(35),
		DUPDATEDDATE DATE,
...
CREATE TABLE MBIDANGUSAHA (
		...
		CNMBIDUSAHA VARCHAR (60) NOT NULL,
...
ALTER TABLE MSEKOLAH ADD CONSTRAINT FK_UNIV FOREIGN KEY (UNIV_ID)
	REFERENCES MUNIV (ID);
...
ALTER TABLE MDETILKURIKULUM ADD CONSTRAINT FK_DET_KURIKULUM FOREIGN KEY (KURIKULUM_ID) 
	REFERENCES MKURIKULUM (ID)
...
CREATE SEQUENCE MTERM_SEQ INCREMENT BY 1 START WITH 100000;
CREATE SEQUENCE TFEEDBACKDOSEN_SEQ INCREMENT BY 1 START WITH 100000;
CREATE SEQUENCE TFEEDBACKWISUDAWAN_SEQ INCREMENT BY 1 START WITH 100000;
...
(15090,2,'menuItem_Admin_MasterTerm',0),
...
ALTER TABLE MFEEDBACK ADD CONSTRAINT MFEEDBACK_MPRODI_FK FOREIGN KEY (PRODI_ID) REFERENCES MPRODI (ID);
...
-- DDL Statements for table TFEEDBACKDOSEN
...
-- DDL Statements for primary key on Table TFEEDBACKDOSEN



ALTER TABLE TFEEDBACKDOSEN 

	ADD CONSTRAINT PK_TFEEDBACKDOSEN PRIMARY KEY
...
-- DDL Statements for foreign keys on Table TFEEDBACKDOSEN



ALTER TABLE TFEEDBACKDOSEN 

	ADD CONSTRAINT FK_TFEEDBACKDOSEN_FEEDBACK FOREIGN KEY
...
ALTER TABLE TFEEDBACKDOSEN 
	...
	ADD CONSTRAINT FK_TFEEDBACKDOSEN_DOSEN FOREIGN KEY
...
ALTER TABLE TFEEDBACKDOSEN 
	...
	ADD CONSTRAINT FK_TFEEDBACKDOSEN_PRODI FOREIGN KEY
...
ALTER TABLE TFEEDBACKDOSEN 
	...
	ADD CONSTRAINT FK_TFEEDBACKDOSEN_SEKOLAH FOREIGN KEY
...
-- DDL Statements for table TFEEDBACKWISUDAWAN
...
CREATE TABLE TFEEDBACKWISUDAWAN  (
...
-- DDL Statements for primary key on Table TFEEDBACKWISUDAWAN



ALTER TABLE TFEEDBACKWISUDAWAN 

	ADD CONSTRAINT PK_TFEEDBACKWISUDAWAN PRIMARY KEY
...
-- DDL Statements for foreign keys on Table TFEEDBACKWISUDAWAN



ALTER TABLE TFEEDBACKWISUDAWAN 

	ADD CONSTRAINT FK_TFEEDBACKWISUDAWAN_FEEDBACK FOREIGN KEY
...
ALTER TABLE TFEEDBACKWISUDAWAN 
	...
	ADD CONSTRAINT FK_TFEEDBACKWISUDAWAN_MAHASISWA FOREIGN KEY
...
ALTER TABLE TFEEDBACKWISUDAWAN 
	...
	ADD CONSTRAINT FK_TFEEDBACKWISUDAWAN_PRODI FOREIGN KEY
...
ALTER TABLE TFEEDBACKWISUDAWAN 
	...
	ADD CONSTRAINT FK_TFEEDBACKWISUDAWAN_SEKOLAH FOREIGN KEY
...
INSERT INTO SEC_RIGHT (RIG_ID, RIG_TYPE, RIG_NAME, VERSION) VALUES (15092,2,'menuItem_Admin_MasterThajar',0);
INSERT INTO SEC_GROUPRIGHT (GRI_ID, GRP_ID, RIG_ID, VERSION) VALUES (14697,13073,15092,0);
COMMIT;
--TAMBAHAN UNTUK MTERM DAN MTHAJAR
ALTER TABLE MTERM ADD COLUMN DTGLMULAI DATE 
ADD COLUMN DTGLAKHIR DATE ;

ALTER TABLE MTERM ADD COLUMN MTH_ID INTEGER; 

CREATE TABLE MTHAJAR (
ID INTEGER NOT NULL, 
CTHAJAR VARCHAR(8) NOT NULL, 
CSMT VARCHAR(1) NOT NULL, 
DTGLMULAI DATE,
...
ALTER TABLE MTHAJAR ADD CONSTRAINT MTHAJAR_PK PRIMARY KEY (ID);

ALTER TABLE MTHAJAR ADD CONSTRAINT MTHAJAR_UK UNIQUE (CTHAJAR,CSMT);
------------------
CREATE SEQUENCE MTHAJAR_SEQ AS INTEGER  START WITH 100000 INCREMENT BY 1 MINVALUE 100000 MAXVALUE 2147483647 NO CYCLE CACHE 20 NO ORDER;
----------------
ALTER TABLE MTERM ADD CONSTRAINT MTERM_MTHAJAR_FK FOREIGN KEY (MTH_ID) 
REFERENCES MTHAJAR(ID);

---TAMBAHAN CONSTRAINT UNTUK DUPLICATE CODE---
ALTER TABLE MDETILKURIKULUM ALTER COLUMN CCOHORT SET NOT NULL;

ALTER TABLE MDETILKURIKULUM ALTER COLUMN MATAKULIAH_ID SET NOT NULL;

ALTER TABLE MGRADE ALTER COLUMN CKDGRADE SET NOT NULL;

ALTER TABLE MKURIKULUM ALTER COLUMN MATAKULIAH_ID SET NOT NULL;
ALTER TABLE MKURIKULUM ALTER COLUMN CCOHORT SET NOT NULL;

REORG TABLE MDETILKURIKULUM ALLOW READ ACCESS ;
REORG TABLE MGRADE ALLOW READ ACCESS ;
REORG TABLE MKURIKULUM ALLOW READ ACCESS ;

---------
--ALTER TABLE MALUMNI ADD CONSTRAINT MALUMNI_UK1 UNIQUE (SEKOLAH_ID, PRODI_ID, CTERM, MAHASISWA_ID);
ALTER TABLE MCALAKADEMIK ADD CONSTRAINT MCALAKADEMIK_UK1 UNIQUE (SEKOLAH_ID, PRODI_ID, CNO);
ALTER TABLE MDETILKURIKULUM ADD CONSTRAINT MDETILKURIKULUM_UK1 UNIQUE (KURIKULUM_ID,PRODI_ID, CCOHORT, MATAKULIAH_ID);
ALTER TABLE MFASILITASRUANG ADD CONSTRAINT MFASILITASRUANG_UK1 UNIQUE (RUANG_ID, FASILITAS_ID);
ALTER TABLE MGRADE ADD CONSTRAINT MGRADE_UK1 UNIQUE (CKDGRADE);
ALTER TABLE MHARI ADD CONSTRAINT MHARI_UK1 UNIQUE (CKDHARI);
ALTER TABLE MHISTKURSUSMHS ADD CONSTRAINT MHISTKURSUSMHS_UK1 UNIQUE (MAHASISWA_ID,CNO);
ALTER TABLE MHISTPANGKATMHS ADD CONSTRAINT MHISTPANGKATMHS_UK1 UNIQUE (MAHASISWA_ID,PANGKATGOLONGAN_ID);
ALTER TABLE MHISTPNDDKMHS ADD CONSTRAINT MHISTPNDDKMHS_UK1 UNIQUE (MAHASISWA_ID,PRODI_ID, JENJANG_ID);
ALTER TABLE MJABATAN ADD CONSTRAINT MJABATAN_UK1 UNIQUE (CKDJABATAN);
ALTER TABLE MJENJANG ADD CONSTRAINT MJENJANG_UK1 UNIQUE (CKDJEN);
ALTER TABLE MKARYAMHS ADD CONSTRAINT MKARYAMHS_UK1 UNIQUE (MAHASISWA_ID,CNO);
ALTER TABLE MKEGIATAN ADD CONSTRAINT MKEGIATAN_UK1 UNIQUE (CKDKGT);
ALTER TABLE MKGTMHS ADD CONSTRAINT MKGTMHS_UK1 UNIQUE (MAHASISWA_ID,CNO);
----------
...
ALTER TABLE MKURIKULUM ADD CONSTRAINT MKURIKULUM_UK1 UNIQUE (CKODEKUR, PRODI_ID, CCOHORT);
ALTER TABLE MKURMHS ADD CONSTRAINT MKURMHS_UK1 UNIQUE (KURIKULUM_ID, MAHASISWA_ID);
ALTER TABLE MMAHASISWA ADD CONSTRAINT MMAHASISWA_UK1 UNIQUE (CNIM);
--ALTER TABLE MMHSPASCAKHS ADD CONSTRAINT MMHSPASCAKHS_UK1 UNIQUE (MAHASISWA_ID,PANGKATGOLONGAN_ID);
ALTER TABLE MPANGKATGOLONGAN ADD CONSTRAINT MPANGKATGOLONGAN_UK1 UNIQUE (CKDPANGKATGOLONGAN);
ALTER TABLE MPBAHASAMHS ADD CONSTRAINT MPBAHASAMHS_UK1 UNIQUE (MAHASISWA_ID,CNO);
ALTER TABLE MPEGAWAI ADD CONSTRAINT MPEGAWAI_UK1 UNIQUE (CNIP);
ALTER TABLE MPEMINATAN ADD CONSTRAINT MPEMINATAN_UK1 UNIQUE (CKDMINAT);
ALTER TABLE MPPUMHSKHUSUS ADD CONSTRAINT MPPUMHSKHUSUS_UK1 UNIQUE (MAHASISWA_ID,CNO);
ALTER TABLE MPRESTASIMHS ADD CONSTRAINT MPRESTASIMHS_UK1 UNIQUE (MAHASISWA_ID,CNO);
ALTER TABLE MPRODI ADD CONSTRAINT MPRODI_UK1 UNIQUE (CKDPROGST,JENJANG_ID);
ALTER TABLE MSEKOLAH ADD CONSTRAINT MSEKOLAH_UK1 UNIQUE (CKDSEKOLAH);
ALTER TABLE MSESIKULIAH ADD CONSTRAINT MSESIKULIAH_UK1 UNIQUE (CKDSESI);
ALTER TABLE MSTATUSMHS ADD CONSTRAINT MSTATUSMHS_UK1 UNIQUE (CKDSTATMHS);
ALTER TABLE MTBMTKL ADD CONSTRAINT MTBMTKL_UK1 UNIQUE (CKDMTK);
ALTER TABLE MUNIV ADD CONSTRAINT MUNIV_UK1 UNIQUE (CKD_UNIV);

ALTER TABLE TABSENDOSEN ADD CONSTRAINT TABSENDOSEN_UK1 UNIQUE (SEKOLAH_ID, PRODI_ID, CTERM, MATAKULIAH_ID, CKELOMPOK, DTGLKUL, PEGAWAI_ID, SESI_ID);
ALTER TABLE TABSENMHS ADD CONSTRAINT TABSENMHS_UK1 UNIQUE (SEKOLAH_ID, PRODI_ID, CTERM, MATAKULIAH_ID, CKELOMPOK, DTGLKUL, MAHASISWA_ID);
--ALTER TABLE TFEEDBACKALUMNI ADD CONSTRAINT TFEEDBACKALUMNI_UK1 UNIQUE (CTERM,SEKOLAH_ID, PRODI_ID, MAHASISWA_ID);
ALTER TABLE TFEEDBACKWISUDAWAN ADD CONSTRAINT TFEEDBACKWISUDAWAN_UK1 UNIQUE (CTERM,SEKOLAH_ID, PRODI_ID, MAHASISWA_ID, CKELOMPOK, FEEDBACK_ID, NNOPERTANYAAN);
ALTER TABLE TLOGNILAI ADD CONSTRAINT TLOGNILAI_UK1 UNIQUE (CTERM,SEKOLAH_ID, MAHASISWA_ID, MATAKULIAH_ID, CKELOMPOK);
ALTER TABLE TPAKETKULIAH ADD CONSTRAINT TPAKETKULIAH_UK1 UNIQUE (CTERM,SEKOLAH_ID, PRODI_ID, MATAKULIAH_ID);


----------------
ALTER TABLE MKGTMHS DROP CONSTRAINT CC1330813032577;

ALTER TABLE MKGTMHS ADD CONSTRAINT FK_KGTMHS_MAHASISWA FOREIGN KEY
...
ALTER TABLE MPRESTASIMHS ADD CONSTRAINT FK_PRESMHS_MAHASISWA FOREIGN KEY
...
ALTER TABLE MPEMINATAN ADD CONSTRAINT FK_MINAT_PRODI FOREIGN KEY
...
ALTER TABLE MSEKOLAH ADD CONSTRAINT FK_SKLH_PEGAWAI FOREIGN KEY
...
ALTER TABLE MKEL ADD CONSTRAINT FK_MKEL_KDPOS FOREIGN KEY

	(POS_ID)

	REFERENCES MKODE_POS
...
ALTER TABLE TFEEDBACKALUMNI ADD CONSTRAINT TFEEDBACKALUMNI_UK1
 UNIQUE (MAHASISWA_ID, CTERM, CKELOMPOK, FEEDBACK_ID, NNOPERTANYAAN, CJAWABAN);
ALTER TABLE TFEEDBACKDOSEN ADD CONSTRAINT TFEEDBACKDOSEN_UK1
 UNIQUE (DOSEN_ID, CTERM, CKELOMPOK, FEEDBACK_ID, NNOPERTANYAAN, CJAWABAN);
