 ...
 */
package id.ac.idu.webui.logging.loginlog;

import com.trg.search.Filter;
import id.ac.idu.backend.model.SecLoginlog;
import id.ac.idu.backend.service.LoginLoggingService;
import id.ac.idu.backend.util.HibernateSearchObject;
import id.ac.idu.gui.service.GuiLoginLoggingService;
import id.ac.idu.webui.logging.loginlog.model.SecLoginlogListModelItemRenderer;
import id.ac.idu.webui.logging.loginlog.model.WorkingThreadLoginList;
import id.ac.idu.webui.util.GFCBaseListCtrl;
import id.ac.idu.webui.util.InputConfirmBox;
