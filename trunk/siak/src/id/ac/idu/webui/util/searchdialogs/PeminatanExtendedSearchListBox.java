 ...
 * Time: 9:08 AM
 */
public class PeminatanExtendedSearchListBox extends Window implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(PeminatanExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Peminatan";
    ...
    private Mpeminatan obj = null;

    // The service from which we get the data
    private MpeminatanService objService;
     ...
     */
    public static Mpeminatan show(Component parent) {
        return new PeminatanExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private PeminatanExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllPeminatanLikeText("", 0, getPageSize());
        List<Mpeminatan> resultList = (List<Mpeminatan>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mpeminatan peminatan = (Mpeminatan) data;

            Listcell lc = new Listcell(peminatan.getCnmminat());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mpeminatan peminatan = (Mpeminatan) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = PeminatanExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllPeminatanLikeText(searchText, start, getPageSize());
        List<Mpeminatan> resultList = (List<Mpeminatan>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (PeminatanExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = PeminatanExtendedSearchListBox.this.listbox.getSelectedItem();
                Mpeminatan peminatan = (Mpeminatan) li.getAttribute("data");
    ...
    public Mpeminatan getObj() {
        return obj;
    }

    public void setObj(Mpeminatan obj) {
        this.obj = obj;
    }

    public MpeminatanService getObjService() {
        if (this.objService == null) {
            this.objService = (MpeminatanService) SpringUtil.getBean("mpeminatanService");
        }
        return objService;
    }

    public void setObjService(MpeminatanService objService) {
