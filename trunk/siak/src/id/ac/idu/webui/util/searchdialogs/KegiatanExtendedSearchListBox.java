 ...
 */
public class KegiatanExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(KegiatanExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Kegiatan";
    ...
    private Mkegiatan obj = null;

    // The service from which we get the data
    private KegiatanService objService;
     ...
     */
    public static Mkegiatan show(Component parent) {
        return new KegiatanExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private KegiatanExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllKegiatanLikeText("", 0, getPageSize());
        List<Mkegiatan> resultList = (List<Mkegiatan>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mkegiatan kegiatan = (Mkegiatan) data;

            Listcell lc = new Listcell(kegiatan.getCnmkgt());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mkegiatan kegiatan = (Mkegiatan) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = KegiatanExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllKegiatanLikeText(searchText, start, getPageSize());
        List<Mkegiatan> resultList = (List<Mkegiatan>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (KegiatanExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = KegiatanExtendedSearchListBox.this.listbox.getSelectedItem();
                Mkegiatan kegiatan = (Mkegiatan) li.getAttribute("data");
    ...
    public Mkegiatan getObj() {
        return obj;
    }

    public void setObj(Mkegiatan obj) {
        this.obj = obj;
    }

    public KegiatanService getObjService() {
        if (this.objService == null) {
            this.objService = (KegiatanService) SpringUtil.getBean("kegiatanService");
        }
        return objService;
    }

    public void setObjService(KegiatanService objService) {
