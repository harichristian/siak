 ...
 */
public class MkabExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(MkabExtendedSearchListBox.class);
    ...
    private Mkab obj = null;

    // The service from which we get the data
    private MkabService objService;
     ...
     */
    public static Mkab show(Component parent) {
        return new MkabExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private MkabExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
        ...
        List<Mkab> resultList = (List<Mkab>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Listcell lc = new Listcell(mkab.getCnamaKab());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mkab mkab= (Mkab) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = MkabExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (MkabExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = MkabExtendedSearchListBox.this.listbox.getSelectedItem();
                Mkab mkab = (Mkab) li.getAttribute("data");
    ...
    public void setObj(Mkab obj) {
        this.obj = obj;
    }

    public MkabService getObjService() {
        if (this.objService == null) {
            this.objService = (MkabService) SpringUtil.getBean("mkabService");
        }
        return objService;
    }

    public void setObjService(MkabService objService) {
