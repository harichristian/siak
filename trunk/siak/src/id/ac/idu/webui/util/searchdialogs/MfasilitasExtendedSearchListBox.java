 ...
 */
public class MfasilitasExtendedSearchListBox extends Window implements Serializable {
    ...
    private Mfasilitas obj = null;

    // The service from which we get the data
    private FasilitasService objService;
     ...
     */
    public static Mfasilitas show(Component parent) {
        return new MfasilitasExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private MfasilitasExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllMfasilitasLikeText("", 0, getPageSize());
        List<Mfasilitas> resultList = (List<Mfasilitas>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mfasilitas mfasilitas = (Mfasilitas) data;

            Listcell lc = new Listcell(mfasilitas.getCnamaFasilitas());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mfasilitas mfasilitas = (Mfasilitas) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = MfasilitasExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllMfasilitasLikeText(searchText, start, getPageSize());
        List<Mfasilitas> resultList = (List<Mfasilitas>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (MfasilitasExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = MfasilitasExtendedSearchListBox.this.listbox.getSelectedItem();
                Mfasilitas mfasilitas = (Mfasilitas) li.getAttribute("data");
    ...
    public Mfasilitas getObj() {
        return obj;
    }

    public void setObj(Mfasilitas obj) {
        this.obj = obj;
    }

    public FasilitasService getObjService() {
        if (this.objService == null) {
            this.objService = (FasilitasService) SpringUtil.getBean("fasilitasService");
        }
        return objService;
    }

    public void setObjService(FasilitasService objService) {
