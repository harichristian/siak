 ...
 * Time: 2:15 PM
 */
public class KurikulumExtendedSearchListBox extends Window implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(KurikulumExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Kurikulum";
    ...
    private Mkurikulum obj = null;

    // The service from which we get the data
    private KurikulumService objService;
     ...
     */
    public static Mkurikulum show(Component parent) {
        return new KurikulumExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private KurikulumExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllKurikulumLikeText("", 0, getPageSize());
        List<Mkurikulum> resultList = (List<Mkurikulum>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mkurikulum obj = (Mkurikulum) data;

            Listcell lc = new Listcell(obj.getCkodekur());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mkurikulum obj = (Mkurikulum) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = KurikulumExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllKurikulumLikeText(searchText, start, getPageSize());
        List<Mkurikulum> resultList = (List<Mkurikulum>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (KurikulumExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = KurikulumExtendedSearchListBox.this.listbox.getSelectedItem();
                Mkurikulum obj = (Mkurikulum) li.getAttribute("data");
    ...
    public Mkurikulum getObj() {
        return obj;
    }

    public void setObj(Mkurikulum obj) {
        this.obj = obj;
    }

    public KurikulumService getObjService() {
        if (this.objService == null) {
            this.objService = (KurikulumService) SpringUtil.getBean("kurikulumService");
        }
        return objService;
    }

    public void setObjService(KurikulumService objService) {
