 ...
 */
public class JabatanExtendedSearchListBox extends Window implements Serializable {
    ...
    private Mjabatan obj = null;

    // The service from which we get the data
    private JabatanService objService;
     ...
     */
    public static Mjabatan show(Component parent) {
        return new JabatanExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private JabatanExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllJabatanLikeText("", 0, getPageSize());
        List<Mjabatan> resultList = (List<Mjabatan>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mjabatan mjabatan = (Mjabatan) data;

            Listcell lc = new Listcell(mjabatan.getCnmjabatan());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mjabatan mjabatan = (Mjabatan) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = JabatanExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllJabatanLikeText(searchText, start, getPageSize());
        List<Mjabatan> resultList = (List<Mjabatan>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (JabatanExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = JabatanExtendedSearchListBox.this.listbox.getSelectedItem();
                Mjabatan mjabatan = (Mjabatan) li.getAttribute("data");
    ...
    public Mjabatan getObj() {
        return obj;
    }

    public void setObj(Mjabatan obj) {
        this.obj = obj;
    }

    public JabatanService getObjService() {
        if (this.objService == null) {
            this.objService = (JabatanService) SpringUtil.getBean("jabatanService");
        }
        return objService;
    }

    public void setObjService(JabatanService objService) {
