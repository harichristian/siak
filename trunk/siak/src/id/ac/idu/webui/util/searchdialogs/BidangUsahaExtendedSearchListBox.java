 ...
 */
public class BidangUsahaExtendedSearchListBox extends Window implements Serializable {
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Fasilitas";
    ...
    private Mbidangusaha obj = null;

    // The service from which we get the data
    private BidangUsahaService objService;
     ...
     */
    public static Mbidangusaha show(Component parent) {
        return new BidangUsahaExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private BidangUsahaExtendedSearchListBox(Component parent) {
        super();
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllBidangusahaLikeText("", 0, getPageSize());
        List<Mbidangusaha> resultList = (List<Mbidangusaha>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mbidangusaha mbidangusaha = (Mbidangusaha) data;

            Listcell lc = new Listcell(mbidangusaha.getCnmbidusaha());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mbidangusaha mbidangusaha = (Mbidangusaha) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = BidangUsahaExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllBidangusahaLikeText(searchText, start, getPageSize());
        List<Mbidangusaha> resultList = (List<Mbidangusaha>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (BidangUsahaExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = BidangUsahaExtendedSearchListBox.this.listbox.getSelectedItem();
                Mbidangusaha mbidangusaha = (Mbidangusaha) li.getAttribute("data");
    ...
    public Mbidangusaha getObj() {
        return obj;
    }

    public void setObj(Mbidangusaha obj) {
        this.obj = obj;
    }

    public BidangUsahaService getObjService() {
        if (this.objService == null) {
            this.objService = (BidangUsahaService) SpringUtil.getBean("bidangUsahaService");
        }
        return objService;
    }

    public void setObjService(BidangUsahaService objService) {
