 ...
 */
public class SesiExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(SesiExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Sesi";
    ...
    private Msesikuliah obj = null;

    // The service from which we get the data
    private SesiService objService;
     ...
     */
    public static Msesikuliah show(Component parent) {
        return new SesiExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private SesiExtendedSearchListBox(Component parent) {
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllSesiLikeText("", 0, getPageSize());
        List<Msesikuliah> resultList = (List<Msesikuliah>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Msesikuliah sesi = (Msesikuliah) data;

            Listcell lc = new Listcell(sesi.getCkdsesi());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Msesikuliah sesi = (Msesikuliah) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = SesiExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllSesiLikeText(searchText, start, getPageSize());
        List<Msesikuliah> resultList = (List<Msesikuliah>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (SesiExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = SesiExtendedSearchListBox.this.listbox.getSelectedItem();
                Msesikuliah sesi = (Msesikuliah) li.getAttribute("data");
    ...
    public Msesikuliah getObj() {
        return obj;
    }

    public void setObj(Msesikuliah obj) {
        this.obj = obj;
    }

    public SesiService getObjService() {
        if (this.objService == null) {
            this.objService = (SesiService) SpringUtil.getBean("sesiService");
        }
        return objService;
    }

    public void setObjService(SesiService objService) {
