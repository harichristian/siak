 ...
 */
public class HariExtendedSearchListBox  extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(HariExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Hari";
    ...
    private Mhari obj = null;

    // The service from which we get the data
    private HariService objService;
     ...
     */
    public static Mhari show(Component parent) {
        return new HariExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private HariExtendedSearchListBox(Component parent) {
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllHariLikeText("", 0, getPageSize());
        List<Mhari> resultList = (List<Mhari>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mhari hari = (Mhari) data;

            Listcell lc = new Listcell(hari.getCnmhari());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mhari hari = (Mhari) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = HariExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllHariLikeText(searchText, start, getPageSize());
        List<Mhari> resultList = (List<Mhari>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (HariExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = HariExtendedSearchListBox.this.listbox.getSelectedItem();
                Mhari hari = (Mhari) li.getAttribute("data");
    ...
    public void setObj(Mhari obj) {
        this.obj = obj;
    }

    public HariService getObjService() {
        if (this.objService == null) {
            this.objService = (HariService) SpringUtil.getBean("hariService");
        }
        return objService;
    }

    public void setObjService(HariService objService) {
