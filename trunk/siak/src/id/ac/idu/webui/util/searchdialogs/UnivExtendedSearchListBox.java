 ...
 */
public class UnivExtendedSearchListBox extends Window implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(UnivExtendedSearchListBox.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Univ";
    ...
    private Muniv obj = null;

    // The service from which we get the data
    private MunivService objService;
     ...
     */
    public static Muniv show(Component parent) {
        return new UnivExtendedSearchListBox(parent).getObj();
    }
     ...
     * @param parent
     */
    private UnivExtendedSearchListBox(Component parent) {
    ...
    private void createBox() {
         ...
         */
        ResultObject ro = getObjService().getAllUnivLikeText("", 0, getPageSize());
        List<Muniv> resultList = (List<Muniv>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Muniv univ = (Muniv) data;

            Listcell lc = new Listcell(univ.getCnamaUniv());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Muniv univ = (Muniv) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = UnivExtendedSearchListBox.this._textbox.getValue();
            // refresh the list
    ...
    void refreshModel(String searchText, int start) {
        ...
        // init the model
        ResultObject ro = getObjService().getAllUnivLikeText(searchText, start, getPageSize());
        List<Muniv> resultList = (List<Muniv>) ro.getList();
        this._paging.setTotalSize(ro.getTotalCount());
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (UnivExtendedSearchListBox.this.listbox.getSelectedItem() != null) {
                Listitem li = UnivExtendedSearchListBox.this.listbox.getSelectedItem();
                Muniv univ = (Muniv) li.getAttribute("data");
    ...
    public void setObj(Muniv obj) {
        this.obj = obj;
    }

    public MunivService getObjService() {
        if (this.objService == null) {
            this.objService = (MunivService) SpringUtil.getBean("munivService");
        }
        return objService;
    }

    public void setObjService(MunivService objService) {
