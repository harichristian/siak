 ...
 */
package id.ac.idu.webui.security.rolegroup;

import id.ac.idu.backend.model.SecGroup;
import id.ac.idu.backend.model.SecRole;
import id.ac.idu.backend.model.SecRolegroup;
import id.ac.idu.backend.service.SecurityService;
import id.ac.idu.backend.util.HibernateSearchObject;
import id.ac.idu.webui.security.groupright.SecGrouprightCtrl;
import id.ac.idu.webui.security.rolegroup.model.SecRolegroupGroupListModelItemRenderer;
import id.ac.idu.webui.security.rolegroup.model.SecRolegroupRoleListModelItemRenderer;
import id.ac.idu.webui.util.GFCBaseCtrl;
import id.ac.idu.webui.util.SelectionCtrl;
...
public class SecRolegroupCtrl extends GFCBaseCtrl implements Serializable, SelectionCtrl<SecRole> {
    ...
    /*
      * (non-Javadoc)
      *
      * @see id.ac.idu.webui.util.SelectionCtrl#getSelected()
      */
    @Override
