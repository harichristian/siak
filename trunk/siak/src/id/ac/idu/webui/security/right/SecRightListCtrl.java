 ...
 */
package id.ac.idu.webui.security.right;

import com.trg.search.Filter;
import id.ac.idu.backend.model.SecRight;
import id.ac.idu.backend.model.SecTyp;
import id.ac.idu.backend.service.SecurityService;
import id.ac.idu.backend.util.HibernateSearchObject;
import id.ac.idu.webui.security.right.model.SecRightListModelItemRenderer;
import id.ac.idu.webui.security.right.model.SecRightSecTypListModelItemRenderer;
import id.ac.idu.webui.security.right.report.SecRightSimpleDJReport;
...
public class SecRightListCtrl extends GFCBaseListCtrl<SecRight> implements Serializable {
     ...
     * see: id.ac.idu.webui.branch.model.BranchListModelItemRenderer.java <br>
     *
     * @param event
     * @throws Exception
     */
