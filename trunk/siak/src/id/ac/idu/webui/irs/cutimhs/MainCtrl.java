...
public class MainCtrl extends GFCBaseCtrl implements Serializable {
    ...
    protected Window windowCutimhsMain;
    ...
    public void onCreate$windowCutimhsMain(Event event) throws Exception {
        windowCutimhsMain.setContentStyle("padding:0px;");
...
//        btnHelp.setVisible(true);
    ...
    public Tcutimhs getSelected() {
        if(selected != null) {
            ...
            String stnow = "CTMS" + dtformat.format(dtnow);
