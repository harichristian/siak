 ...
 * @author sge
 */
public class FasilitasSimpleDJReport extends Window implements Serializable {
    ...
    public FasilitasSimpleDJReport(Component parent) throws InterruptedException {
        super();
