 ...
 */
public class MfasilitasruangSimpleDJReport extends Window implements Serializable {
	...
	public MfasilitasruangSimpleDJReport(Component parent) throws InterruptedException {
		super();
