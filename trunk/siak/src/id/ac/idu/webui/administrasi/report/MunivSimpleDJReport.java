 ...
 */
public class MunivSimpleDJReport extends Window implements Serializable {
    ...
    public MunivSimpleDJReport(Component parent) throws InterruptedException {
        super();
    ...
    public void doPrint() throws JRException, ColumnBuilderException, ClassNotFoundException, IOException {
        ...
        String filNr = Labels.getLabel("common.Muniv.ID");
        ...
        drb.setSubtitle("List of Munivs: " + ZksampleDateFormat.getDateTimeFormater().format(new Date()));
        ...
        MunivService as = (MunivService) SpringUtil.getBean("munivService");
        List<Muniv> resultList = as.getAllMunivs();

        // Create Datasource and put it in Dynamic Jasper Format
        List data = new ArrayList(resultList.size());

        for (Muniv obj : resultList) {
            Map<String, String> map = new HashMap<String, String>();
            map.put("ckdUniv", obj.getCkdUniv());
            map.put("cnamaUniv", obj.getCnamaUniv());
            map.put("alamatUniv", String.valueOf(obj.getAlamatUniv()));
