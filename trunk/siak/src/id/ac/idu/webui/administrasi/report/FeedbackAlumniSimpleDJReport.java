 ...
 * Time: 4:33 AM
 */
public class FeedbackAlumniSimpleDJReport extends Window implements Serializable {
    ...
    private final String zksample2title = "Feedback Alumni Report";

    public FeedbackAlumniSimpleDJReport(Component parent) throws InterruptedException {
        super();
