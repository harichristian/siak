 ...
 */
public class TfeedbackinstansiSimpleDJReport extends Window implements Serializable {
    ...
    public TfeedbackinstansiSimpleDJReport(Component parent) throws InterruptedException {
        super();
