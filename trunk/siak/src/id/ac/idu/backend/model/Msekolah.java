...
public class Msekolah  implements java.io.Serializable {
    ...
    public Msekolah(int id, Mpegawai mpegawai, String ckdsekolah, String cnamaSekolah, String csingkatan, String cnamaIng, String visi, String misi, String noSk) {
        this.id = id;
    ...
    public Msekolah(int id, Mpegawai mpegawai, String ckdsekolah, String cnamaSekolah, String csingkatan, String cnamaIng, String visi, String misi, String noSk, Date dcreateddate, String ccreatedby, Date dupdateddate, String dupdatedby, Set<Tabsenmhs> tabsenmhses, Set<Tabsendosen> tabsendosens, Set<Thistkerja> thistkerjas, Set<Mprodi> mprodis, Set<Tjadujian> tjadujians, Set<Tjadkulmaster> tjadkulmasters, Set<Malumni> malumnis, Set<Tlognilai> tlognilais, Set<Msesikuliah> msesikuliahs, Set<Tpaketkuliah> tpaketkuliahs, Set<Tjadkuldetil> tjadkuldetils, Set<Tirspasca> tirspascas, Set<Mcalakademik> mcalakademiks) {
       this.id = id;
       this.mpegawai = mpegawai;
       this.ckdsekolah = ckdsekolah;
       this.cnamaSekolah = cnamaSekolah;
