...
public class Mmahasiswa  implements java.io.Serializable {
    ...
    public Mmahasiswa(int id, Mprodi mprodi, Mpeminatan mpeminatan, Mjenjang mjenjang, String cnim, String cnama, String noktp, String cjnsmhs, String calamat, String cnormh, String crt, String crw, String cnotelp, Integer kodeposId, String ctemplhr, Date dtglhr, Character cjenkel, Character cgoldar, String ckdagama, Character cstatnkh, Character cwarga, String cnosttb, Date dtglsttb, Date dtglmasuk, Date dtglwisuda, Date dtglyudisi, Date dtglteori, Character cflagspbm, Character cflagnilai, String cemail, String cnohp, String cnmkntor, String calmkntor, String ctelpkntor, String cfaxkantor, String ckdposkntor, String calamatsrt, Integer kodeposSrtId, String ckdstatmhs, String cthnlaporan, String cketkerja, String ctujuan, String cgelombang, String cstatawal, Date dcreateddate, String ccreatedby, Date dupdateddate, String cupdatedby, Set<Tabsenmhs> tabsenmhses, Set<Mkgtmhs> mkgtmhses, Set<Mhistpangkatmhs> mhistpangkatmhses, Set<Mpbahasamhs> mpbahasamhses, Set<Tlognilai> tlognilais, Set<Mmhspascakhs> mmhspascakhses, Set<Malumni> malumnis, Set<Mkurmhs> mkurmhses, Set<Mppumhskhusus> mppumhskhususes, Set<Mhistkursusmhs> mhistkursusmhses, Set<Tirspasca> tirspascas, Set<Mhistpnddkmhs> mhistpnddkmhses, Set<Mprestasimhs> mprestasimhses, Set<Tcutimhs> tcutimhses) {
       this.id = id;
       this.mprodi = mprodi;
    ...
    public Integer getKodeposId() {
        return this.kodeposId;
    }
    
    public void setKodeposId(Integer kodeposId) {
        this.kodeposId = kodeposId;
    }
    ...
    public Integer getKodeposSrtId() {
        return this.kodeposSrtId;
    }
    
    public void setKodeposSrtId(Integer kodeposSrtId) {
        this.kodeposSrtId = kodeposSrtId;
    }
