...
public class Tfeedbackwisudawan implements java.io.Serializable {
    ...
    /** default constructor */
    public Tfeedbackwisudawan() {
    }

	/** minimal constructor */
    public Tfeedbackwisudawan(int id, String cterm, Msekolah msekolah, Mprodi mprodi, String ckelompok, Mmahasiswa mmahasiswa, Mfeedback mfeedback, int nnopertanyaan) {
        this.id = id;
    ...
    /** full constructor */
    public Tfeedbackwisudawan(int id, String cterm, Msekolah msekolah, Mprodi mprodi, String ckelompok, Mmahasiswa mmahasiswa, Mfeedback mfeedback, int nnopertanyaan, String cjawaban, String ccreatedby, Date dcreateddate, String cupdateby, Date dupdateddate) {
        this.id = id;
        this.mfeedback = mfeedback;
        this.cterm = cterm;
        this.msekolah = msekolah;
